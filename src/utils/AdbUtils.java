	...
	public static void rootComandDisablePackage() {
		try {
			...
			for (String value : Configure.map.values()) {
				...
				if (value.equals("me.mizhuan") || value.equals("io.appium.unlock") || value.equals("io.appium.settings")
						|| value.equals("com.jiesong.myapplicationlist") || value.equals("com.adsmobile.mrzd")
						|| value.equals("com.qihoo.permmgr") || value.equals("com.jskj.besensible")
						|| value.equals("com.jifen.qukan") || value.equals("com.coohua.xinwenzhuan")
		...
		try {
			...
			for (int i = 0; i < strs.length; i++) {
				...
				if (splitStr.length > 1) {
					if ((!splitStr[1].equals("android")) && (!splitStr[1].equals("huawei"))
							&& (!splitStr[1].equals("google")) && (!splitStr[1].equals("mediatek"))
							&& (!splitStr[1].equals(""))) {
